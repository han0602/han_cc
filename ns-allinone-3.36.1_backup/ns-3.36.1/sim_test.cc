...
main(int argc, char* argv[])
{
   ...
   // cmd.AddValue("openGymPort", "Port number for OpenGym env. Default: 5555", openGymPort);
    ...
    accessLink.SetDeviceAttribute("DataRate", StringValue("1500Mbps"));
    ...
    bottleneckLink.SetChannelAttribute("Delay", StringValue("35ms"));
    ...
    Config::Set("/NodeList/4/$ns3::TcpL4ProtocolCustom/SocketType", StringValue("ns3::TcpCubic"));
